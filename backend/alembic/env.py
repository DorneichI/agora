...
# DATABASE_URL from the environment overrides alembic.ini's placeholder value.
...
from app.gameplay import models as gameplay_models  # noqa: E402,F401 (registers gameplay tables)
